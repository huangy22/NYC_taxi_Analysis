...
df_trip = pd.read_csv("../original_data/trip_data/trip_data_{0}.csv".format(job_id))
df_fare = pd.read_csv("../original_data/trip_fare/trip_fare_{0}.csv".format(job_id))

rename_columns(df_trip, df_fare)
df = merge(df_trip, df_fare)
drop_wrong_data(df)

df.to_csv("trip_data_2013_{0}.csv".format(job_id))
